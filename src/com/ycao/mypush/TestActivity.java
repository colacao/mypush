...
public class TestActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            HttpResponse response = httpClient.execute(getMethod); //??µ·GETè¯·æ?
           ...
           // Log.i(TAG, "resCode = " + response.getStatusLine().getStatusCode()); //?·å??????
            //Log.i(TAG, "result = " + EntityUtils.toString(response.getEntity(), "utf-8"));//?·å?????¨å?åº??å®?
